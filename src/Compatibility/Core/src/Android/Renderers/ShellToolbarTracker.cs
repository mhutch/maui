...
namespace Microsoft.Maui.Controls.Compatibility.Platform.Android
{
	public class ShellToolbarTracker : Java.Lang.Object, AView.IOnClickListener, IShellToolbarTracker, IFlyoutBehaviorObserver
	{
		...
		protected virtual void UpdateToolbarItems(Toolbar toolbar, Page page)
		{
			...
			toolbar.UpdateMenuItems(sortedItems, page.FindMauiContextOnParent(), TintColor, OnToolbarItemPropertyChanged, _currentMenuItems, _currentToolbarItems);
		...
		void OnToolbarItemPropertyChanged(object sender, PropertyChangedEventArgs e)
		{
			...
			_toolbar.OnToolbarItemPropertyChanged(e, (ToolbarItem)sender, sortedItems, Page.FindMauiContextOnParent(), TintColor, OnToolbarItemPropertyChanged, _currentMenuItems, _currentToolbarItems);
		}
